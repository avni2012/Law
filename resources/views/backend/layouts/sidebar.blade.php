    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu @if(request()->segment(2) == 'home' || request()->segment(2) == 'advices' || request()->segment(2) == 'court-appearances' || request()->segment(2) == 'expert-reports' || request()->segment(2) == 'cle-seminars' || request()->segment(2) == 'instruction-forms' || request()->segment(2) == 'qca-legal' || request()->segment(2) == 'cost-management'){{"nav-item-expanded nav-item-open"}}@endif">
