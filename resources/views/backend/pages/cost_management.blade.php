                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="section3_sub_heading" class="form-control" placeholder="Enter home page section3_sub_heading" value="{{ old('section3 sub heading', @$cost_management->section3_sub_heading) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="section4_sub_heading" class="form-control" placeholder="Enter home page section4_sub_heading" value="{{ old('section4 sub heading', @$cost_management->section4_sub_heading) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="section5_sub_heading" class="form-control" placeholder="Enter home page section5_sub_heading" value="{{ old('section5 sub heading', @$cost_management->section5_sub_heading) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
