        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 px-0 cost-consultants-left with-image-left pay-cost-left">
                    <img src="{{ asset('public/backend/images/pages/'.$cost_management->section2_image) }}" alt="legal-cost-consultants" class="img-fluid h-100">
                </div>
                @endif
                @if(!empty($main_page) && $cost_management != null)
                <div
        ...
        <div class="container-lg">
            ...
            <div class="best-practice-section position-relative p-0" id="tab_3">
                @if($cost_management->section4_image != null)
                    <img src="{{ asset('public/backend/images/pages/'.$cost_management->section4_image) }}" alt="best-practice"   class="img-fluid best-practice-image">
                @endif
