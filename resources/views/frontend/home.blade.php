	                        ...
	                        <div class="col-md-3 col-sm-6 col-12 px-md-2 px-0 mb-md-0 mb-2 pe-0">
	                            <div class="service">
	                                <a href="{{ $home_page_settings->advice_link }}" class="d-block">
	                                    <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->advice_image) }}" alt="Advice-services" class="w-100">
	                        ...
	                        <div class="col-md-3 col-sm-6 col-12 px-sm-2 px-0 mb-md-0 mb-2 pe-0">
	                            <div class="service">
	                                <a href="{{ $home_page_settings->drafting_link }}" class="d-block">
	                                    <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->drafting_image) }}" alt="Drafting-services"
	                                        class="w-100">
	                        ...
	                        <div class="col-md-3 col-sm-6 col-12 px-md-2 px-0 mb-sm-0 mb-2 pe-0">
	                            <div class="service">
	                                <a href="{{ $home_page_settings->settlement_conference_team_link }}" class="d-block">
	                                    <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->settlement_conference_team_image) }}"
	                        ...
	                        <div class="col-md-3 col-sm-6 col-12 px-sm-2 px-0 mb-sm-0 mb-2 pe-0">
	                            <div class="service">
	                                <a href="{{ $home_page_settings->court_appearances_link }}" class="d-block">
	                                    <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->court_appearances_image) }}" alt="Court Appearances copy"
	                                        class="w-100">
	                        ...
	                        <div class="col-md-3 col-sm-6 col-12 px-md-2 px-0 mb-md-0 mb-2 pe-0">
	                            <div class="service">
	                                <a href="{{ $home_page_settings->expert_reports_link }}" class="d-block">
	                                    <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->expert_report_image) }}" alt="Expert Reports" class="w-100">
	                        ...
	                        <div class="col-md-3 col-sm-6 col-12 px-sm-2 px-0 mb-md-0 mb-2 pe-0">
	                            <div class="service">
	                                <a href="{{ $home_page_settings->alternative_costs_resolution_link }}" class="d-block">
	                                    <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->alternative_costs_resolution_image) }}" alt="Alternative
	                        ...
	                        <div class="col-md-3 col-sm-6 col-12 px-md-2 px-0 mb-sm-0 mb-2 pe-0">
	                            <div class="service">
	                                <a href="{{ $home_page_settings->cle_seminars_link }}" class="d-block">
	                                    <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->cle_seminars_image) }}" alt="CLE Seminars" class="w-100">
	                        ...
	                        <div class="col-md-3 col-sm-6 col-12 px-sm-2 px-0 mb-sm-0 mb-2 pe-0">
	                            <div class="service">
	                                <a href="{{ $home_page_settings->instruction_forms_link }}" class="d-block">
	                                    <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->instructions_forms_image) }}" alt="Instruction" class="w-100">
	...
	<section class="our-office-section">
	    ...
	    <div class="container-lg">
	        ...
	        <div class="our-offie-body position-relative text-center mt-5">
	            <img src="{{ asset('public/backend/images/pages/'.$home_page_settings->section3_image) }}" alt="office-bg-image" class="img-fluid">
